...
An enterprise-grade, OpenGAP-compliant AI agent for **Other**, engineered for framework portability across OpenAI SDK, CrewAI, Claude Code, and Lyzr.

## Domain Overview
- **Category:** Other
- **Primary Role:** Dean of Academic Admissions & Equity Compliance Auditor
